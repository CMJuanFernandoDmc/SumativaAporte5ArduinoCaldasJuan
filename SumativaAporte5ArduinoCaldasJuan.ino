...
const char* API_KEY = "AIzaSyCoXEuhdbEYc1SRCnefY-5MTioos7Is5kM";
const char* DATABASE_URL = "https://sumativae2aporte5-default-rtdb.firebaseio.com/";
const char* USER_EMAIL = "caldas@gmail.com";
